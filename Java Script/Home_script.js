...
function hotelsave_bookbtn(){
   ...
   document.getElementsByClassName('HotelConfirmation_popup_div')[0].style.display = "block"; 
  document.getElementById("hotelsavediv")[0].style.display = "none";
}
...
fetch('http://3.108.240.106:8097/poja/getallPojjas')
.then(response => response.json())
.then(data => {  console.log(data.data[0])
...
.then(data => {  console.log(data.data) 
  ...
  data.data.map( (product) => {
    ...
    <div id="home_top_rated_div">
        ...
        <p class="top_visited_hotel_name small_hotel_name">Ram Ghat</p>
...
.then(data => {  console.log(data.data[0].name) 
  ...
  document.getElementsByClassName('ujjainpopup_price')[2].innerHTML = `&#8377; ${data.data[0].price} ` ;
   ...
   // image fetch 
        ...
        // fetch('http://13.48.227.61:8097/guide/AllGuides')
        // .then(response => response.json())
        // .then(data => {  console.log(data.data)  
        //   document.getElementsByClassName('ujjainpopup_img')[0].src = `http://13.48.227.61:8097/guide/displayHotelImage?id=${data.data[0].id}`
  ...
  sessionStorage.setItem("ujjain_ID",data.data[0].id );
        ...
        document.getElementsByClassName('ujjainpopup_price')[2].innerHTML = `&#8377; ${data.data[0].price} ` ;
          ...
          .then(data => {  console.log(data.data[1].id)  
            document.getElementsByClassName('ujjainpopup_img')[0].src = `http://3.108.240.106:8097/guide/displayHotelImage?id=${data.data[1].id}`
  ...
  .then(data => {  console.log(data.data) 
    ...
    data.data.map( (product) => {
      ...
      data2 +=`
                ...
                <img class="Package_imgs" src="http://3.108.240.106:8097/guide/displayHotelImage?ids=${product.id}" alt="" srcset="">
                <div>  
...
function maabagFirstcard() {
  ...
  var user_id = localStorage.getItem('User-ID');
   ...
   fetch("http://3.108.240.106:8097/admin/api/ujjain/book", requestOptions)
     ...
     document.getElementById('maabagConfirmation_popupdivv').style.display = "block";
  ...
  .then(data => {  console.log(data.data) 
    ...
    data.data.map( (product) => {
      ...
      <div class="Ujjain_FamousPujas_div shoppingdivs_contents">
          <img src="http://13.48.227.61:8097/shopping/displayHotelImage?id=${product.id}" class="Ujjain_FamousPujas_imgs shopimg" alt=""
              srcset="">
          <p class="Famous_puja_name">${product.name}</p>
          <span class="Famous_puja_price shopprice">&#8377; ${product.price} </span>
          <input type="button" class="Famous_puja_booknow_btn shopbtn" value="Book Now">
      </div>
  </div>
